...
const BlockCards = ({ content }) => {
    ...
    return (
        <div id={slug} className={`z-30 max-w-5xl mx-auto block_container`}>
        ...
        items-center gap-16 4xl:px-0 xl:text-center`}>
                ...
                <div className={`grid grid-cols-1 lg:grid-cols-2 mt-10 xl:mt-0 gap-5 lg:flex-row lg:gap-x-10 lg:gap-y-14 text-center`}>
                    {
                        items.map((item, i) => {
